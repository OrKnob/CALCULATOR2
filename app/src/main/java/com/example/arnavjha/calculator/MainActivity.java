package com.example.arnavjha.calculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        SharedPreferences sh1 = getSharedPreferences("data",MODE_PRIVATE);
        String s1 = sh1.getString("data1"," ");
        HIS.setText(s1);
    ...
    protected void onPause() {
        ...
        edit.putString("data1",HIS.getText().toString()  + "   ");
        edit.commit();
